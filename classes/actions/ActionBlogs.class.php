 ...
 * @since 1.0
 */
class PluginSecretblog_ActionBlogs extends Action {
	/**
	 * Инициализация
	 */
	...
	protected function EventAjaxSearch() {
		 ...
		 * Ищем блоги
		 */
		$aResult=$this->Blog_GetBlogsByFilter(array('exclude_type' => array('personal', 'secret'),'title'=>"%{$sTitle}%"),array('blog_title'=>'asc'),1,100);
		/**
	...
	protected function EventShowBlogs() {
		 ...
		 */
		$aFilter=array(
			'exclude_type' => array('personal', 'secret')
		);
		/**
